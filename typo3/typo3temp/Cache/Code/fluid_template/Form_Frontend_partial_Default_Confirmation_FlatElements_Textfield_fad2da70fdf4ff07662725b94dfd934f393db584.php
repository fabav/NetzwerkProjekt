<?php
class FluidCache_Form_Frontend_partial_Default_Confirmation_FlatElements_Textfield_fad2da70fdf4ff07662725b94dfd934f393db584 extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments16['value'] = \TYPO3\CMS\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($currentVariableContainer->getOrNull('model'), 'additionalArguments.value', $renderingContext);
