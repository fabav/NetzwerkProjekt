<?php
class FluidCache_Standalone_template_file_index_c2bb1b99f0fa07212d08c647c337dfc681530ddb extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '              
      ...
      <div class="ebox2">
        <div class="hexagon"><span class="icon icon-info"></span></div>
        ';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\CObjectViewHelper
$arguments7 = array();
